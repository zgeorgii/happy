 ...
 alert("Hi there "+ user + " Imma axe you a question!!!");
  ...
  function questionOne(){
    ...
    if(answer1.toLowerCase() === "y" || answer1.toLowerCase() === "yes") {
      res1.textContent = "You're right!!!";
      counter +=1;
    } else {
      res1.textContent = "You lose :( " + "Kyle like cats.";
    }
    console.log(answer1);
  }
  function questionTwo(){
    ...
    if(answer2.toLowerCase() === "y" || answer2.toLowerCase() === "yes"){
      res2.textContent = "YAYYY you're right Kyle enjoy learning!!";
      counter +=1;
    } else {
      res2.textContent = "Awwwh! WRONG!!!";
    }
    console.log(answer2);
  }
  function questionThree(){
    ...
    if(answer3.toLowerCase() === "y" || answer3.toLowerCase() === "yes") {
      res3.textContent = user + " you are  correct!";
      counter +=1;
    } else {
      res3.textContent = "sorry "+ user + " , Kyles eyes are blue.";
    }
    console.log(answer3);
  }
  function questionFour(){
    do {
      ...
      if (bonus == "6") {
        counter +=1;
        res4.textContent = ("Wow!!!! you're right!!!, GOOD JOB!!! " + user + " you got " + counter +"/4 correct");
      } else if(bonus < 6) {
